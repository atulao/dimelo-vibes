-- Drop and recreate notification type enum to ensure all values are present
...
DROP TRIGGER IF EXISTS notify_on_session_status_change ON public.sessions;
...
-- Drop and recreate trigger
DROP TRIGGER IF EXISTS notify_on_new_question ON public.questions;
...
-- Drop and recreate trigger
DROP TRIGGER IF EXISTS notify_on_question_upvote ON public.questions;
...
-- Drop and recreate trigger
DROP TRIGGER IF EXISTS notify_on_new_insight ON public.ai_insights;
